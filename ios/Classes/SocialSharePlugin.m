...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
   ...
   f([@"shareInstagramStory" isEqualToString:call.method]){
      ...
      NSString *attributionURL = call.arguments[@"attributionURL"];
        NSString *backgroundImage = call.arguments[@"backgroundVideo"];
        fprintf(stdout, "%s", [attributionURL UTF8String]);
        fprintf(stdout, "%s", [backgroundImage UTF8String]);
      ...
      NSURL *urlScheme = [NSURL URLWithString:@"instagram-stories://share"];
       ...
       if ([[UIApplication sharedApplication] canOpenURL:urlScheme]) {
           ...
           if (isFileExist) {
               ...
               NSData *data = [[NSFileManager defaultManager] contentsAtPath:backgroundImage];
               NSArray *pasteboardItems = @[@{@"com.instagram.sharedSticker.backgroundVideo" : data,
            ...
            if (@available(iOS 10.0, *)) {
                ...
                printf("GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG");
